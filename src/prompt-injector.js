...
try {
    ...
    _getContext = () => (typeof window.getContext === 'function' ? window.getContext() : null);
    _setExtensionPrompt = (...args) => {
        if (typeof window.setExtensionPrompt === 'function') return window.setExtensionPrompt(...args);
